          ...
          <div className="vl-container">
            ...
            <div className="vl-sidebar">
              ...
              <div className="info-card">
                ...
                <p>
                  <strong>Disbursed:</strong> <span>{formatDate(data.loan.disbursement_date)}</span>
                </p>
                <p>
                      ...
                      Math.round(
                        data.loan.interest_type === 'REDUCING'
                          ? (Number(data.loan.outstanding_amount) *
                              ...
                              100
                          : (Number(data.loan.principal_amount) * Number(data.loan.interest_rate)) /
                              100
                      )
                    )}
                  </p>
                    ...
                    >
                      ...
                      <button
                        style={{
                          ...
                          border: 'none',
                          color:
                            activePenaltyTab === 'applied' ? 'var(--accent)' : 'var(--text-muted)',
                      ...
                      <>
                        ...
                        {(() => {
                          ...
                          return (
                            <HistoryTable
                              variant="red"
                              headers={['Date Range / Date', 'Total / Amount', 'Reason', 'Actions']}
                              ...
                              mapRow={(item) => (
                                ...
                                >
                                  ...
                                  <td>
                                    ₹
                                    {formatCurrency(
                                      item.type === 'automatic' ? item.amount : item.penalty_amount
                                    )}
                                  </td>
                                  <td>
                                    {item.reason}{' '}
